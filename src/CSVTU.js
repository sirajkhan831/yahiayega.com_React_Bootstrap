  ...
  return (
    <div>
      ...
      <div className="container-fluid csvtu-content">
        <h2 className="h2 year-text" style={{ fontSize: '3rem', color: 'rgb(30, 32, 37)', marginTop: '7rem', marginBottom: '4rem' }}>Computer Science Engineering</h2>
        <div className="row">
          ...
          <div className="col-sm year" style={{ minHeight: '28rem', maxWidth: '34rem', paddingLeft: '3%', paddingRight: '3%', paddingTop: '3%' }}>
            <h2 className="h2 year-text" style={{ float: 'left', color: 'rgb(30, 32, 37)', marginLeft: '32%' }}>4th
              year</h2><br />
            <h2 className="para" style={{ float: 'left', marginTop: '2rem', fontSize: '1.3rem' }}>This is a sample second semester
              para to check if everything is working fine or not</h2>
          </div>
      ...
      <div className="container-fluid csvtu-content" style={{ backgroundColor: 'rgb(21, 29, 32)' }}>
        <h2 className="h2 year-text" style={{ fontSize: '3rem', color: 'rgb(30, 32, 37)', marginTop: '7rem', marginBottom: '4rem', color: 'rgb(170, 126, 102)' }}>Civil Engineering</h2>
        <div className="row">
          ...
          <div className="col-sm year" style={{ minHeight: '28rem', maxWidth: '34rem', paddingLeft: '3%', paddingRight: '3%', paddingTop: '3%', color: 'rgb(170, 126, 102)' }}>
            <h2 className="h2 year-text" style={{ float: 'left', color: 'rgb(30, 32, 37)', marginLeft: '32%', color: 'rgb(170, 126, 102)' }}>4th
              year</h2><br />
            <h2 className="para" style={{ float: 'left', marginTop: '2rem', fontSize: '1.3rem' }}>This is a sample second semester
              para to check if everything is working fine or not</h2>
          </div>
      ...
      <div className="container-fluid csvtu-content">
        <h2 className="h2 year-text" style={{ fontSize: '3rem', color: 'rgb(30, 32, 37)', marginTop: '7rem', marginBottom: '4rem' }}>Civil Engineering</h2>
        <div className="row">
          <div className="col-sm year" style={{ minHeight: '28rem', maxWidth: '34rem', paddingLeft: '3%', paddingRight: '3%', paddingTop: '3%' }}>
            <h2 className="h2 year-text" style={{ float: 'left', color: 'rgb(30, 32, 37)', marginLeft: '32%' }}>2nd year</h2><br />
            <h2 className="para" style={{ float: 'left', marginTop: '2rem', fontSize: '1.3rem' }}>This is a sample second semester
