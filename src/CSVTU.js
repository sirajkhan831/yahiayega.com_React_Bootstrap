        ...
        <div>
            ...
            <div className="container-fluid csvtu-content">
                ...
                <div className="row">
                    ...
                    <div className="col col-cse" style={{ padding: '2rem' }}><h2 className="h2 blue-text" style={{ fontSize: '2rem' }}>4th Year</h2>
            ...
            <div className="container-fluid csvtu-content" style={{ backgroundColor: 'rgb(30, 32, 37)' }}>
                ...
                <div className="row">
                    ...
                    <div className="col col-cse" style={{ padding: '2rem' }}><h2 className="h2 wheat-text" style={{ fontSize: '2rem' }}>4th Year</h2>
